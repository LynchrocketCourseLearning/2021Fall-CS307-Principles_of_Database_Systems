...
import cn.edu.sustech.cs307.util.otherUtil;

import java.util.*;

public class othersPrerequisite extends otherUtil {
    private static HashMap<Prerequisite,BooleanTreeNode> correspondMap;

    private othersPrerequisite(){
        super();
    }
    ...
    public static void main(String[] args) {
        ...
        Prerequisite p = transformPrerequisite(or1);
        System.out.println(getGroupCount(p));
